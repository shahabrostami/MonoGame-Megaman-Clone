...
namespace Game1
{
    class PlayerStates
    {
        ...
        public static PlayerStateAnimation DAMAGED = new PlayerStateAnimation("HURT");
        ...
        public static void LoadContent(Player player, Texture2D texture, Sprite sprite)
        {
            ...
            BasePlayerAnimation damaged = new PlayerAnimationHurt(player, playerSpriteSpec, sprite.animations[3]);
